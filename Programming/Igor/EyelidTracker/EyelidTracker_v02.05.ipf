...
Function AnalyzeVideoFunc(ctrlName) : ButtonControl
	...
	Make /N=(numFrames) /O eyelidPositionIndex=0

	//=============================================
	// Create TraceWindow
	DoWindow /K TraceWindow
	Display /N=TraceWindow /W=(450, 400, 750, 600) eyelidPositionIndex
	...
	// Get baseline
	frameIndex = 0
	Variable baseline = ImageProcessingFunc()	
	...
	for(frameIndex = 0; frameIndex < numFrames; frameIndex += 1)
		...
		eyelidPositionIndex[frameIndex] =  (baseline - ImageProcessingFunc()) / baseline
...
Function ImageProcessingFunc()
	...
	WAVE roiImage, M_MovieFrame, M_RGB2Gray
